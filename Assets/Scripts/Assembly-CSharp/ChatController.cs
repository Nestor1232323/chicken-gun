...
public class ChatController : Photon.MonoBehaviour
{
	...
	private string _playerName
	{
		get
		{
			return GameController.instance.OurPlayer.playerInfo.name;
		}
	}
	...
	{
		touchScreenKeyboard = TouchScreenKeyboard.Open(string.Empty, TouchScreenKeyboardType.Default, false, false, false, false, "Enter your message");
	}
